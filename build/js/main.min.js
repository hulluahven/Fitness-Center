...
var gymVideo = document.querySelector('[data-video]');
var gymLink = document.querySelector('[data-link]');
var gymButton = document.querySelector('[data-button]');
var tabSection = document.querySelector('[data-tabs]');
var tabButtons = tabSection.querySelectorAll('[data-tab]');
var tabCards = tabSection.querySelectorAll('[data-card]');
var coachesSection = document.querySelector('[data-coaches]');
var coachesSlider = coachesSection.querySelector('[data-slider]');
var buttonCoachesBack = coachesSection.querySelector('[data-back]');
var buttonCoachesNext = coachesSection.querySelector('[data-next]');
var rewiewsSection = document.querySelector('[data-rewiews]');
var rewiewsSlider = rewiewsSection.querySelector('[data-slider]');
var buttonRewiewsBack = rewiewsSection.querySelector('[data-back]');
var buttonRewiewsNext = rewiewsSection.querySelector('[data-next]');
var pageForm = document.querySelector('[autocomplete="off"]');
var userPhones = document.querySelectorAll('input[type=tel]'); // ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (coachesSlider) {
    var coachesSwiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](coachesSlider, {
      loop: true,
      keyboard: {
        enabled: true,
        onlyInViewport: true
  ...
  if (rewiewsSlider) {
    var rewiewsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](rewiewsSlider, {
      slidesPerView: 1,
      keyboard: {
        enabled: true,
        onlyInViewport: true
  ...
  if (userPhones) {
    ...
    var onNumberKeyDown = function onNumberKeyDown(e) {
      var input = e.target;
    ...
    if (pageForm) {
      pageForm.addEventListener('submit', function (evt) {
        ...
        userPhones.forEach(function (phone) {
          var valueLength = phone.value.length;
